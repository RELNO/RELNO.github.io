---
title: "Shifting Priorities, Finding Places"
subtitle: "How Media Lab and HafenCity University researchers are tackling the refugee crisis in Hamburg, using algorithms and LEGO bricks."
slug: "shifting-priorities-finding-places"
date: "2016-09-15"
status: "published"
author: "Ariel Noyman and Kent Larson, Changing Places group"
description: "Media Lab and HafenCity University researchers tackle the refugee crisis in Hamburg with algorithms, LEGO bricks, and community engagement."
image: "/writings/shifting-priorities-finding-places/finding-places-platform.jpeg"
imageAlt: "Finding Places tangible urban simulation platform."
imageCaption: "Finding Places: A tangible urban simulation platform. Photo credit: Ariel Noyman"
sourceUrl: "https://medium.com/mit-media-lab/shifting-priorities-finding-places-9ad3bdbe38b8"
---

**By Ariel Noyman and Kent Larson, Changing Places group**

*Originally published by [MIT Media Lab on Medium](https://medium.com/mit-media-lab/shifting-priorities-finding-places-9ad3bdbe38b8) on September 15, 2016.*

In late 2015, in collaboration with HafenCity University (HCU), we launched a project to help Hamburg transform its proposed 2024 Olympic Village and the adjacent Rothenburgsort neighborhood into an "innovation district." At a meeting with Mayor Olaf Scholz, we presented ideas to build a large [CityScope](http://cp.media.mit.edu/spatial-planning-platforms/) platform of the area using our optically tagged LEGO bricks, simulation algorithms, and augmented reality to model urban interventions for more livable, entrepreneurial communities.

![People placing LEGO objects on an augmented planning table while data is shown on a large screen](/writings/shifting-priorities-finding-places/lego-housing-units.jpeg)
...
Only nine months after the failed referendum, our Finding Places project (a play on our research group name, [Changing Places](http://www.media.mit.edu/research/groups/changing-places)) has helped to identify locations for accommodating thousands of refugees in Germany's second-largest city; construction is already underway at several of these sites. Finding Places is being cited as a creative, positive model for dealing with a "[grave humanitarian crisis](http://www.state.gov/secretary/remarks/2014/05/226116.htm)" and what US Secretary of State John Kerry has called a "[near existential threat](http://www.state.gov/secretary/remarks/2016/02/252486.htm?goMobile=0)" caused by the recent mass influx of refugees from the horrors of war.

## Emergency mode

![Warehouse in Hamburg retrofitted for temporary refugee shelter](/writings/shifting-priorities-finding-places/warehouse-refugee-shelter.jpeg)

*Emergency measures: Warehouse in Hamburg which was retrofitted for temporary refugee shelter. Photo credit: Kent Larson*

About 400 refugees from the Middle East arrived in Hamburg daily last year. When we visited the city last year, we had a first-hand opportunity to see temporary tent-cities and camps set up in and around the city. Our guide, Anselm Sprandel, the head of the Central Refugees Coordination Staff of Hamburg ([ZFK](http://www.hamburg.de/zkf/)), showed us the reality of the refugees' living conditions. In a converted warehouse, crammed together, were hundreds of tiny living spaces divided by thin partitions; inside were multiple bunk beds, a small table, and hanging sheets that provided minimal privacy. Near the city's central railway station, volunteers and longtime refugees were helping newcomers find food and shelter. It was incredibly moving and upsetting to witness this scene in a vibrant, world-class city. That the situation continued to increase in magnitude contributed to our resolve to assist in creating solutions.

Just a few months earlier and in a very different atmosphere, the MIT Media Lab [had signed](http://www.hamburg-news.hamburg/en/cluster/trade-finances/hcu-and-mit-co-operate/) an agreement with the City of Hamburg to establish a long-term research collaboration. HafenCity University (HCU) and the Changing Places group were chosen to lead this effort, and together we established the [CityScienceLab](https://www.hcu-hamburg.de/research/citysciencelab/) (CSL) at HCU, an international center for advanced urban research and design. In keeping with the Media Lab's focus on deployment, CSL is a living lab that extends Changing Places group research, using it for real-life scenarios in Andorra, Boston, Taipei, and other locations around the world.
...
<iframe src="https://www.youtube-nocookie.com/embed/d_4vViH3lFo?autoplay=1&amp;mute=1&amp;playsinline=1" width="854" height="480" frameborder="0" loading="eager" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen title="Finding Places in action"></iframe>
...
![Groups of district leaders and residents meeting around an interactive table](/writings/shifting-priorities-finding-places/district-leaders-residents.jpeg)
...
![People evaluating possible sites using maps color-coded according to zoning, ownership, and environmental conditions](/writings/shifting-priorities-finding-places/zoning-ownership-environmental-maps.jpeg)
...
![Participant placing a square zoom window over the area of interest on an interactive table](/writings/shifting-priorities-finding-places/zoom-window-neighborhoods.jpeg)
...
![Interactive table at the end of a workshop with suggested sites identified](/writings/shifting-priorities-finding-places/interactive-table-suggested-sites.jpeg)
...
![Participants meeting to discuss results and observe the overall impact of other sessions](/writings/shifting-priorities-finding-places/participants-results-discussion.jpeg)
...
**MIT Media Lab - Changing Places group (Kent Larson, Ariel Noyman, Ira Winder)**  
**HafenCity University - CityScienceLab**  
**The City of Hamburg**

**[Kent Larson](http://cp.media.mit.edu/kent-larson/) directs the City Science initiative and the Changing Places group at the MIT Media Lab. His research is focused on developing urban interventions that enable more entrepreneurial, livable, high-performance districts in cities. Projects include advanced simulation and augmented reality for urban design, transformable micro-housing for millennials, mobility-on-demand systems that create alternatives to private automobiles, and living lab deployments in Hamburg, Andorra, Taipei, Lisbon, and Boston. Larson and researchers from his group received the "10-Year Impact Award" from Ubicomp 2014: a "test of time" award for work that, with the benefit of that hindsight, has had the greatest impact. Larson practiced architecture for 15 years in New York City, with design work published in Architectural Record, Progressive Architecture, Global Architecture, The New York Times, A+U, and Architectural Digest. His book, Louis I. Kahn: Unbuilt Masterworks was selected as one of the Ten Best Books in Architecture of the year by The New York Times Review of Books.**

**[Ariel Noyman](http://cp.media.mit.edu/ariel-noyman) is a research scientist and project leader in the MIT Media Lab's [Changing Places](http://www.media.mit.edu/research/groups/changing-places) group. He oversees the integration of the group's diverse research topics (city simulation, urban mobility, innovation districts, and smart housing) to provide comprehensive solutions for large-scale urban questions. Noyman is an architect and an urban designer with over a decade of experience in large-scale urban design, institutional and public projects, urban simulation, and data visualization. He has practiced at leading architectural and design firms in the US, Europe, and Israel, and his work has been featured in media outlets including Domus, Archdaily, Dezeen, and The Guardian. Noyman has taught architecture, urbanism, and city science at MIT and Northeastern University, and Bezalel Academy in Israel.**
